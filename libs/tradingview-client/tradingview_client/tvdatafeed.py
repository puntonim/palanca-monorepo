...
Src: https://github.com/rongardF/tvdatafeed/blob/main/tvDatafeed/main.py
...
import datetime
import enum
#import json  # nimiq: edited.
import logging
import random
import re
import string
#import pandas as pd  # nimiq: edited.
from websocket import create_connection
import requests
import json
import log_utils as logger  # nimiq: edited.


# logger = logging.getLogger(__name__)  # nimiq: edited.
...
class TvDatafeed:
    ...
    def __init__(
        ...
        if self.token is None:
            ...
            # nimiq: converted to info as the warning ends up in my aws-watchdog emails.
            # logger.warning(
    ...
    def __create_df(raw_data, symbol):
        try:
            # nimiq: use raw string to avoid SyntaxWarning.
            ...
            # nimiq: commented out the whole pandas block.
            #data = pd.DataFrame(
    ...
    #) -> pd.DataFrame:  # nimiq: edited.
    ) -> list:
        """get historical data

        nimiq: return None for unknown symbols.
         But sometimes (often) the response is None even for a valid symbol/exchange.
        ...
        Returns:
            #pd.Dataframe: dataframe with sohlcv as columns  # nimiq: edited.
            list: list with sohlcv as columns
        """
